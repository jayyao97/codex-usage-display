/*******************************************************************************
 * Montserrat is Copyright 2024 The Montserrat.Git Project Authors and is
 * licensed under the SIL Open Font License 1.1. See LICENSES/OFL-1.1.txt.
 *
 * Size: 100 px
 * Bpp: 4
 * Opts: --font /tmp/Montserrat-Medium.ttf --size 100 --bpp 4 --format lvgl --symbols 0123456789% --no-compress --lv-font-name font_montserrat_100 --output src/fonts/font_montserrat_100.c
 ******************************************************************************/

#include <lvgl.h>

#ifndef FONT_MONTSERRAT_100
#define FONT_MONTSERRAT_100 1
#endif

#if FONT_MONTSERRAT_100
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 1349, .box_w = 78, .box_h = 72, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2808, .adv_w = 1067, .box_w = 58, .box_h = 73, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 4925, .adv_w = 592, .box_w = 27, .box_h = 71, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 5884, .adv_w = 918, .box_w = 53, .box_h = 71, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 7766, .adv_w = 915, .box_w = 53, .box_h = 72, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 9674, .adv_w = 1070, .box_w = 63, .box_h = 71, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 11911, .adv_w = 918, .box_w = 53, .box_h = 72, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 13819, .adv_w = 987, .box_w = 55, .box_h = 73, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 15827, .adv_w = 957, .box_w = 53, .box_h = 71, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 17709, .adv_w = 1030, .box_w = 56, .box_h = 73, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 19753, .adv_w = 987, .box_w = 55, .box_h = 73, .ofs_x = 2, .ofs_y = -1}
};
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_montserrat_100 = {
#else
lv_font_t font_montserrat_100 = {
#endif
